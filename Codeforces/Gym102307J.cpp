...
struct mxinfo
{
	long long m,s,t;
	mxinfo(){}
	mxinfo(long long _,long long __,long long ___):m(_),s(__),t(___){}
...
struct mninfo
{
	long long m,s,t;
	mninfo(){}
	mninfo(long long _,long long __,long long ___):m(_),s(__),t(___){}
...
int main()
{
	...
	while (m--)
	{
		...
		else
		{
			...
			{
				add(1,l,n+1,-x);changemax(1,l,n+1,0);
				add(1,1,r+1,-x);changemax(1,1,r+1,0);
			}
		}
	}
	return 0;
